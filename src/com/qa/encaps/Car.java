...
public class Car {
	...
	public Car(String colour, String brand, String model, int year, int speed, int noWheels) {
		this.colour = colour;
		this.brand = brand;
		this.model = model;
		this.year = year;
	...
	public Car(String colour, String brand, String model, int year, double carValue) {
		super();
		this.colour = colour;
		this.brand = brand;
		this.model = model;
